...
<html lang="en">
  ...
  ?>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2022. Made by <b> UTKARSH MISHRA</b> <br>INTERN @ALPHA AUTOMATION PVT. LTD.</p>
        <div>
        <marquee width="60%" direction="right" height="100px" style="color:green" scrollamount="12" >
This Webpage is just for learning purposes designed by UTKARSH MISHRA for Internship project under ALPHA AUTOMATION PVT. LTD.All Rights Reserved.
</marquee>
         </div>
      </footer>
